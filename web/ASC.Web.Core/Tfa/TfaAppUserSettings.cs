...
{
    [Serializable]
    public class TfaAppUserSettings : ISettings, ICacheWrapped<CachedTfaAppUserSettings>
    {
        ...
        {
            var settings = settingsManager.LoadForUser<TfaAppUserSettings, CachedTfaAppUserSettings>(userId);
            ...
            if (salt == 0)
            {
                ...
                settingsManager.SaveForUser<TfaAppUserSettings, CachedTfaAppUserSettings>(settings, userId);
            }
            return salt;
        }
        ...
        {
            return settingsManager.LoadForUser<TfaAppUserSettings, CachedTfaAppUserSettings>(userId).CodesSetting;
        }
        ...
        {
            return settingsManager.LoadForUser<TfaAppUserSettings, CachedTfaAppUserSettings>(guid).CodesSetting.Any();
        }
        ...
        public static void DisableForUser(IServiceProvider serviceProvider, SettingsManager settingsManager, Guid guid)
        {
            ...
            {
                settingsManager.SaveForUser<TfaAppUserSettings, CachedTfaAppUserSettings>(defaultSettings, guid);
            }
        }

        public CachedTfaAppUserSettings WrapIn()
        {
            var cached = new CachedTfaAppUserSettings();
            if (CodesSetting != null) cached.CodesSetting.Add(this.CodesSetting);
            cached.SaltSetting = this.SaltSetting;

            return cached;
        }
    }

    public partial class CachedTfaAppUserSettings : ICustomSer<CachedTfaAppUserSettings>,
        ICacheWrapped<TfaAppUserSettings>
    {
        public void CustomDeSer() { }
        public void CustomSer() { }

        public TfaAppUserSettings WrapIn()
        {
            return new TfaAppUserSettings
            {
                CodesSetting = this.CodesSetting,
                SaltSetting = this.SaltSetting
            };
        }
    }
}