...
namespace ASC.Core
{
    partial class AzRecordStore : IEnumerable<AzRecord>, ICustomSer<AzRecordStore>
    {
        ...
        public void Add(AzRecord r)
        {
            ...
            {
                ByObjectId[id] = new AzRecordList();
            }
            ByObjectId[id].AzRecords.RemoveAll(a => a.SubjectId == r.SubjectId && a.ActionId == r.ActionId); // remove escape, see DbAzService
            ByObjectId[id].AzRecords.Add(r);
        }
        ...
        public void Remove(AzRecord r)
        {
            ...
            if (ByObjectId.ContainsKey(id))
            {
                ByObjectId[id].AzRecords.RemoveAll(a => a.SubjectId == r.SubjectId && a.ActionId == r.ActionId && a.Reaction == r.Reaction);
            }
        }
        ...
        public void CustomSer()
        {
            ...
            {
                foreach (var record in pair.Value.AzRecords)
                {
                    record.CustomSer();
                }
            }
