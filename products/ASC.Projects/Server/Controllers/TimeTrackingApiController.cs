...
namespace ASC.Projects.Controllers
{
    ...
    public class TimeTrackingApiController : BaseApiController
    {
        ...
        [Read(@"time/filter")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(List<TimeTrackingItemViewModel>))]
        public IActionResult GetLoggedTimeByFilter(int? projectId,
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(List<TimeTrackingItemViewModel>))]
        public IActionResult GetTaskTimeByFilter(int? projectId,
            bool myProjectsAreNeeded,
            int? milestoneId,
            bool myMilestonesAreNeeded,
            int? tagId,
        ...
        public IActionResult GetTaskLoggedItems(int taskId)
        {
        ...
        [Update(@"time/{timeId}")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(TimeTrackingItemViewModel))]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public IActionResult UpdateLoggedTime(TimeTrackingItemViewModel data)
        {
            var validationResult = new TimeTrackingItemValidator()
                .Validate(data);
        ...
        public IActionResult UpdateLoggedItemsByPaymentStatus(List<int> itemIds, PaymentStatus newStatus)
        {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(List<TimeTrackingItemViewModel>))]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public IActionResult RemoveTaskLoggedTimes(List<int> itemIds)
        {
