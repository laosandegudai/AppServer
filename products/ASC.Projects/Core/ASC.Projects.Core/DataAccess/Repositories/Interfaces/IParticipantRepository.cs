...
{
    /// <summary>
    /// An interface of repository working with <see cref="DbProjectParticipant"/> entity.
    /// </summary>
    public interface IParticipantRepository : IRepository<DbProjectParticipant, int>
    {
        /// <summary>
        ...
        List<int> GetFollowingProjectIds(Guid participantId);
        ...
        List<int> GetMyProjects(Guid participantId);
        ...
        List<int> GetObservableProjectIds(Guid participantId);
        ...
        void AddToFollowingProjects(int project, Guid participantId);
        ...
        void RemoveFromFollowingProjects(int projectId, Guid participantId);
    }
}
