...
//        bool CanCreateEntities(DbProject project);
...
//        bool CanReadEntity(DbProject project, Guid userId);

//        bool CanUpdateEntity(DbProject project);

//        bool CanGoToFeed(DbProject project, Guid userId);

//        bool CanEditTeam(DbProject project);

//        bool CanReadFiles(DbProject project);

//        bool CanReadFiles(DbProject project, Guid userId);

//        bool CanEditComment(DbProject project, DbComment comment);

//        bool CanReadContacts(DbProject project);

//        bool CanLinkContact(DbProject project);
//    }
//}
