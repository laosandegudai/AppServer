...
namespace ASC.Projects.Core.BusinessLogic.Security
{
    public class CommonSecurityManager : ICommonSecurityManager
    {
        ...
        public CommonSecurityManager(IProjectManager projectManager,
        ...
        public bool IsInTeam(ProjectData project, Guid userId, bool includeAdmin = true)
        {
            ...
            var isInTeam = project != null && _projectManager.IsInTeam(project.Id, userId);
        ...
        public bool IsFollow(ProjectData project, Guid userId)
        {
            ...
            var result = isPrivate && _projectManager.IsFollowing(project.Id, userId);
        ...
        public bool GetTeamSecurity(ProjectData project, Guid userId, ProjectTeamSecurity security)
        {
            ...
            var s = _projectManager.GetTeamSecurity(project.Id, userId);

            var result = (s & security) != security && _projectManager.IsInTeam(project.Id, userId);
        ...
        public bool GetTeamSecurityForParticipants(ProjectData project, Guid userId, ProjectTeamSecurity security)
        {
            ...
            var teamSecurity = _projectManager.GetTeamSecurity(project.Id, userId);
            
            var result = (teamSecurity & security) != security;
